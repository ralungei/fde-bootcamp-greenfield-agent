...
"""before_agent_callback for account_management_specialist — resets local_noinput_counter on module entry (BR-TV-006)."""
...
def before_agent_callback(callback_context: CallbackContext) -> Optional[Content]:
    ...
    current_agent = "account_management_specialist"
