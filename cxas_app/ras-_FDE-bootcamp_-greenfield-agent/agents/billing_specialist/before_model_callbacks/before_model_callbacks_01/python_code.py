...
# We use this for the deterministic parts (greeting, language, silences, caller-said numbers); without it the model could skip legal lines or identify via caller ID.
"""
