...
| **6** | **Suite de Simulaciones (`70 Public + 30 Secret`)** (`2.5`) | 100 escenarios multi-turno ejecutados en CXAS Labs Agent Academy (Run `f5b233531be74ad5bf231f67f72d7243`) y en local con `session_parameters: {}` (**`92/100 PASS` global = `92.0%`**, **`63/70` públicos = `90.0%`**, **`29/30` ocultos = `96.7%`**). | ✅ **HECHO** | Agent Academy Run `f5b233531be74ad5bf231f67f72d7243` + `eval-reports/sim_report_2026-09-24_0006.html` |
